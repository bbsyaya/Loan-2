...
public class ServletLoanDetils extends HttpServlet {
	...
	/**
	 * уекиюз201226010427 2015/6/1
	 */
	public ServletLoanDetils() {
		super();
	}
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		String sql="select * from admin_loan_record where id=?";
...
//			record.setGuaIDCardPhoto("guaIDCardPhoto");
		...
		request.getRequestDispatcher("LoanDetils.jsp").forward(request, response);
