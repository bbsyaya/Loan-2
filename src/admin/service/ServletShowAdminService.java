...
public class ServletShowAdminService extends HttpServlet {
	 ...
	 */
	public ServletShowAdminService() {
		super();
	}
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		request.getRequestDispatcher("AdminLoginedServiceItem.jsp").forward(request, response);
