...
<div class="container">
  <div class="header">
   您现在的位置：系统首页-><a href="Center.jsp"><font color="black">个人中心</font></a>-><b>账户安全</b>-><b>用户验证</b>-><b>修改密码</b>
  </div>
  <div class="content">
    <div  class="table-a">
  ...
  <tr>
    <td>&nbsp;&nbsp;<a href="toLoan" ><font color="black">我要贷款</font></a></td>
  </tr>
   <tr>
    <td>&nbsp;&nbsp;<a href="Record.jsp"><font color="black">贷款记录</font></a></td>
  </tr>
</table>
   ...
   <tr>
    ...
    <tr>
    	<td width="224" height="69" background="image/suo.jpg">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;新密码</td>
  		<td width="485"><input type="password" name="newPassword" id="newPassword" value="" placeholder="请输入新密码" autocomplete="off"/></td>
    </tr>
    <tr>
    	<td width="224" height="69" background="image/suo.jpg">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;确认新密码</td>
  		<td width="368"><input type="password" name="confirmNewPassword" id="confirmNewPassword" value="" placeholder="需与新密码相同" autocomplete="off"/></td>
    </tr>
    
    <tr align="left">
    	<td></td>
    	<td><input type="submit"  name="submit" id="submit" value="确定" style="width:80px;height:30px" />
    		<input type="button"  name="cancel" id="cancel" value="取消" style="width:80px;height:30px" onclick="window.location.href='Secure.jsp'" />
    	</td>
    </tr>
