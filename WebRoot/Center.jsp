...
<div class="container">
  <div class="header">
   您现在的位置：系统首页-><b>个人中心首页</b>
  </div>
  <div class="content">
    <div  class="table-a">
    <table width="208"  align="left" >
  <tr>
    <td bgcolor="#00CCFF" ><span style="color: white">个人中心</span></td>
  </tr></table>
  <table width="725">
  <tr>
    <td bgcolor="#00CCFF" ><span style="color: white">系统信息</span></td>
  </tr></table>
  <table width="208" align="left" >
   <tr><td height="20" >&nbsp; </td></tr>
   <tr>
    <td height="37"><b>个人信息</b></td>
  </tr>
  <tr>
    <td>&nbsp;&nbsp;<a href="UserInfo"><font color="black">查看个人信息</font></a></td>
  </tr>
  <tr>
  ...
  <tr>
   ...
   <tr>
    ...
    <table width="725" height="452">
    <tr><td width="304" height="27">&nbsp;</td></tr>
    <tr><td height="168"  background="image/hi.jpg"></td>
    	<td width="402">尊敬的<font color="blue">${user.userName}</font><br>欢迎你登录小额贷款在线服务系统!<br>
        请点击左侧项目查看个人中心<br>
       <font color="red"> 如果您的密码在其他网站也使用，建议您<a href="VerifyUser.jsp"></>修改本网站密码</a>。</font>
       <tr><td height="247">&nbsp;</td><td  background="image/hi2.jpg">&nbsp;</td><td width="3"  ></td></tr>
    </table>
