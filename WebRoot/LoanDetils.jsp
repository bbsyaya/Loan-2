...
<div class="container">
  <div class="header">
   您现在的位置：系统首页-><a href="AdminCenter.jsp"><font color="black">管理中心</font></a>-><b>贷款申请表信息</b>
  </div>
  <div class="content">
...
<table width="1100" border="0">
	<tr>
	    ...
	    <input type="button" id="button" name="button"  value="返回" style="width:100px; height:30px;" onclick="window.location.href='AdminCenter.jsp'" />
	    </div></td>
	</tr>
</table>
