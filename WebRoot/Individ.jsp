...
<div class="container">
  <div class="header">
   您现在的位置：系统首页-><a href="Center.jsp" ><font color="black">个人中心</font></a>-><b>查看个人信息</b>
  </div>
  <div class="content">
    <div  class="table-a">
  ...
  <table width="725">
  <tr>
    <td bgcolor="#00CCFF" ><span style="color: white">查看个人信息</span></td>
  </tr></table>
  <table width="208" align="left" >
   ...
   <tr>
    ...
    <c:choose>
 	<c:when test="${!(empty userinfo) }">
      ...
      <tr>
        <td width="242" height="40" align="right">用户名:</td>
        <td width="242">&nbsp;&nbsp;${user.userName}</td>
        <td width="242"></td>
      </tr>
       <tr>
        <td width="242" height="40"  align="right">姓名:</td>
        <td width="242">&nbsp;&nbsp;${user.realName}</td>
        <td width="242"></td>
      </tr>
       <tr>
        <td width="242" height="40"  align="right">性别:</td>
        <td width="242">&nbsp;&nbsp;${user.sex}</td>
        <td width="242"></td>
      </tr>
       <tr>
        <td width="242" height="40"  align="right">证件类型:</td>
        <td width="242">&nbsp;&nbsp;${user.paper}</td>
        <td width="242"></td>
      </tr>
       <tr>
        <td width="242" height="40"  align="right">证件号码:</td>
        <td width="242">&nbsp;&nbsp;${user.paperID}</td>
        <td width="242"></td>
      </tr>

      <tr><td>联系方式</td></tr>
        <tr>
        <td width="242" height="40" align="right">手机:</td>
        <td width="242">&nbsp;&nbsp;${user.mobilePhone}</td>
        <td width="242"></td>
      </tr>
       <tr>
        <td width="242" height="40"  align="right">固话:</td>
        <td width="242">&nbsp;&nbsp;${user.telePhone}</td>
        <td width="242"></td>
      </tr>
       <tr>
        <td width="242" height="40"  align="right">地址:</td>
        <td width="242">&nbsp;&nbsp;${user.address}</td>
        <td width="242"></td>
      </tr>
      </c:forEach>
      </c:when>
