...
<BODY style="MARGIN: 0px" ><!--å¯¼èªé¨å-->
<DIV class=top_table>
<DIV class=top_table_leftbg>
<DIV class=system_logo>
<table><tr><td><font  size=6 color=white ><b>&nbsp;&nbsp;小额担保贷款</b></font></td></tr></table></DIV>
<TABLE align=right><TR><TD></TD> <TD><font size=4 color=white >欢迎您！${user.userName}&nbsp;&nbsp; <a href="Center.jsp"><b>个人空间</b></a></font></TD></TR></TABLE>
<DIV class=menu  >
<UL >
  <LI   id=menu_0  ><A 
  href="HomePage.jsp" >首页</A> </LI>
    <LI id=menu_0 ><A 
  href="showUserService">服务细则</A> 
	</LI>
  <LI id=menu_1 ><A 
  href="ToLoan.jsp">我要贷款</A> </LI>
