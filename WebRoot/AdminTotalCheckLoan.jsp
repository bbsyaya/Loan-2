...
<div class="container">
  <div class="header">
   您现在的位置：系统首页-><a href="AdminCenter.jsp"><font color="black">管理中心</font></a>-><b>累计审贷</b>
  </div>
  <div class="content">
    <div  class="table-a">
  ...
  <table width="770">
  <tr>
    <td bgcolor="#00CCFF" ><span style="color: white">累计审贷</span></td>
  </tr></table>
   <table width="180" align="left" >
  ...
  <form id="form" name="form" action="searchName" method="post" onsubmit="return CheckForm()" >
  	<table width="770px">
  	<tr>
    ...
    <table width="770px" border="1" cellpadding="0" cellspacing="0">
      <tr bgcolor="lightblue">
        ...
        <td align="center">申款日期</td>
        <td align="center">申款人</td>
