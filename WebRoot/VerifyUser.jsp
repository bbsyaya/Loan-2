...
<head>
<script language="javascript" src="js/verifyuser.js"></script>
...
<div class="container">
  <div class="header">
   您现在的位置：系统首页-><a href="Center.jsp"><font color="black">个人中心</font></a>-><b>账户安全</b>-><b>用户验证</b>
  </div>
  <div class="content">
    <div  class="table-a">
  ...
  <tr>
   ...
   <tr>
	...
	<form id="form1" name="form1" method="post" action="verify" onsubmit="return CheckForm()">
    <table width="725">
    <c:choose>
 	<c:when test="${!(empty userinfo) }">
   	<c:forEach items="${userinfo}" var="user">
   <tr>
    	<td width="224" height="69" background="image/suo.jpg">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;用户名</td>
  		<td width="485"><input type="text" name="userName" id="userName" value="${user.userName}" onfocus="this.blur()"/></td>
    </tr>
    <tr>
    	<td width="224" height="69" background="image/suo.jpg">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;绑定手机</td>
  		<td width="485"><input type="text" name="mobilePhone" id="mobilePhone" value="" placeholder="请输入手机号" autocomplete="off"/></td>
    </tr>
    <tr>
    	<td width="224" height="69" background="image/suo.jpg">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;密保问题</td>
  		<td width="368"><label for="question"></label>
    ...
    <tr>
    	<td width="224" height="69" background="image/suo.jpg">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;密保答案</td>
  		<td width="368"><input type="text" name="answer" id="answer" value="" placeholder="请输入密保问题" autocomplete="off"/></td>
    </tr>
    <tr align="left">
    	<td></td>
    	<td><input type="submit"  name="submit" id="submit" value="确定" style="width:80px;height:30px" />
